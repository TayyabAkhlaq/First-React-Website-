...
function Common(props) {
    const stat = props.value1;
    const stat1 = props.value2; 
    const stat2 = props.value3;
    return (
        <>
            ...
            <div className="container m-5 ">
                <div className='row '>
                    ...
                    <h2 style={{display:"flex",justifyContent:"center", alignItem:"center"}}>{stat}</h2>
                    <h3 style={{display:"flex",justifyContent:"center", alignItem:"center" , color:"aqua"}}>{stat1}</h3>
                    <h6 style={{display:"flex",justifyContent:"center", alignItem:"center",fontFamily:"Lucida Console"}}>{stat2}</h6>
                    </div>
